...
4. After applying: `md5sum swing_trader.py swing_core.py golden_scoring_expected.json` must be unchanged (`a10c31d0` / `55ffd7f2` / `04b8e0cf`). Report the two docs' new line counts + the mirror copy confirmation.
